      ...
      data.combat.trackers.forEach((pj, i) => {
        ...
        $(".ctr-list").append(
          `<div class="ctr-element" style="white-space: nowrap; position: relative;">
            ...
            <input type="text" style="width: 20px;" class="ctr-uEstres" placeholder="UE" title="UE (${(+pj.status.uEstres+6) + ', ' + (+pj.status.uEstres+12) + ', ' + (+pj.status.uEstres+18)})" value="${pj.status.uEstres}"/>
